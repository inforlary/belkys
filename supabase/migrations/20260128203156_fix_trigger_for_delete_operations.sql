/*
  # Fix trigger_update_action_on_workflow_change for DELETE operations

  1. Changes
    - Update trigger function to properly handle DELETE operations (where NEW is NULL)
    - Use TG_OP to distinguish between UPDATE and DELETE operations
...
BEGIN
  ...
  IF TG_TABLE_NAME = 'qm_processes' THEN
    ...
    -- DELETE işleminde NEW yok, sadece OLD var
