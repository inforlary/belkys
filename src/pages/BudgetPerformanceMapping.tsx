...
export default function BudgetPerformanceMapping() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Program - Müdürlük Eşleştirme</h1>
        <p className="text-gray-600 mt-2">
          Müdürlüklerinizi bütçe programları, alt programları ve faaliyetleri ile eşleştirin.
        </p>
      </div>
