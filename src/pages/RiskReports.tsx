        ...
        <>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="mb-4">
                  <h2 className="text-xl font-bold text-gray-900 mb-2">Risk & İç Kontrol Haritası</h2>
                  <p className="text-sm text-gray-600">Risk-hedef-gösterge ilişki ağı ve iç kontrol entegrasyonu</p>
                </div>
                <RiskICMap />
              </div>
            </>
