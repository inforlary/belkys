      ...
      if (assessment.id) {
        ...
        if (data) {
          setAssessments(prev => prev.map(a =>
            a.condition_id === data.condition_id ? data : a
          ));
        }
      }
    } catch (error) {
                        ...
                        {isStandardExpanded && (
                          <div className="bg-white rounded-lg border border-slate-200 overflow-hidden">
                            <div className="bg-slate-100 px-3 py-2 border-b border-slate-200">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 grid grid-cols-12 gap-3">
                                  <div className="col-span-4 text-xs font-semibold text-slate-700 uppercase">Genel Şart</div>
                                  <div className="col-span-2 text-xs font-semibold text-slate-700 uppercase text-center">Durum</div>
                                  <div className="col-span-2 text-xs font-semibold text-slate-700 uppercase text-center">Puan</div>
                                  <div className="col-span-3 text-xs font-semibold text-slate-700 uppercase">Açıklama</div>
                                  <div className="col-span-1 text-xs font-semibold text-slate-700 uppercase text-center">İşlem</div>
                                </div>
                              </div>
                            </div>
                            {standardConditions.map((condition) => {
                              ...
                              return (
                                <div key={condition.id} className="bg-slate-50 border-b border-slate-200 last:border-b-0">
                                  <div className="p-3">
                                    <div className="flex items-center gap-3">
                                      <div className="flex-shrink-0 w-8 h-8 bg-blue-100 rounded flex items-center justify-center">
                                        <span className="text-xs font-bold text-blue-700">{condition.code.split('.').pop()}</span>
                                      </div>

                                      <div className="flex-1 grid grid-cols-12 gap-3 items-center">
                                        <div className="col-span-4">
                                          <div className="text-xs font-medium text-slate-900 mb-0.5">{condition.code}</div>
                                          <div className="text-xs text-slate-600 line-clamp-2">{condition.description}</div>
                                        </div>
                                        ...
                                        <div className="col-span-2">
                                          <div className="flex gap-1">
                                            <button
                                              ...
                                              className={`flex-1 p-1.5 rounded border transition-all ${
                                            ...
                                            <button
                                              ...
                                              className={`flex-1 p-1.5 rounded border transition-all ${
                                                assessment.compliance_status === 'PARTIAL'
                                                  ...
                                                  : 'border-slate-300 hover:border-yellow-400 hover:bg-yellow-50/50'
                                              }`}
                                              title="Kısmen"
                                            >
                                          ...
                                          <div className="flex gap-0.5">
                                            {[1, 2, 3, 4, 5].map((score) => (
                                              <button
                                                ...
                                                className={`flex-1 px-1.5 py-1 rounded border transition-all ${
                                        ...
                                        <div className="col-span-3">
                                          <input
                                            ...
                                            placeholder="Mevcut durum açıklaması..."
                                          />
                                        </div>
                                        ...
                                        <div className="col-span-1 flex items-center justify-end gap-1">
                                          ...
                                          {conditionActions.length > 0 && (
                                            <button
                                              ...
                                              title={`${conditionActions.length} Eylem`}
                                            >
                                              <span className="text-xs font-medium">{conditionActions.length}</span>
                                            </button>
                                          )}
                                        </div>
                                      </div>
