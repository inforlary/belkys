...
import { Plus, Edit2, Trash2, TrendingDown, X, Save, ChevronRight, ChevronDown, Upload } from 'lucide-react';
...
interface RevenueCode {
  ...
  full_code: string;
  is_active: boolean;
  children?: RevenueCode[];
}

export default function StandardRevenueCodesManager() {
  const [codes, setCodes] = useState<RevenueCode[]>([]);
  const [allCodes, setAllCodes] = useState<RevenueCode[]>([]);
  const [loading, setLoading] = useState(true);
  const [showModal, setShowModal] = useState(false);
  const [editingItem, setEditingItem] = useState<RevenueCode | null>(null);
  ...
  const loadCodes = async () => {
    try {
      ...
      console.error('Gelir kodları yüklenirken hata:', error);
      alert('Gelir kodları yüklenemedi');
    } finally {
      setLoading(false);
    }
  };

  const buildTree = (items: RevenueCode[]): RevenueCode[] => {
    const map = new Map<string, RevenueCode>();
    const roots: RevenueCode[] = [];
  ...
  const handleAdd = (parentCode?: RevenueCode) => {
    setEditingItem(null);
    setFormData({
  ...
  const handleEdit = (item: RevenueCode) => {
    setEditingItem(item);
    setFormData({
      level: item.level,
      code: item.code,
  ...
  const handleDelete = async (item: RevenueCode) => {
  ...
  const renderTree = (items: RevenueCode[], level = 0) => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Standart Gelir Ekonomik Kodları</h3>
          <p className="text-sm text-gray-600 mt-1">
            Tüm belediyeler için geçerli olan gelir ekonomik kodları (Seviye I-IV)
          </p>
        </div>
        <div className="flex items-center gap-3">
          <Button
      ...
      {showModal && (
        <Modal
          ...
          title={editingItem ? 'Gelir Kodu Düzenle' : `Yeni Seviye ${formData.level} Kodu Ekle`}
        >
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              ...
              <div className="bg-white border border-blue-300 rounded p-2 mt-1 font-mono text-xs text-gray-800">
                <div>03&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Teşebbüs ve Mülkiyet Gelirleri</div>
                <div>03&nbsp;&nbsp;01&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mal ve Hizmet Satış Gelirleri</div>
                <div>03&nbsp;&nbsp;01&nbsp;&nbsp;05&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Atık Su Gelirleri</div>
                <div>03&nbsp;&nbsp;01&nbsp;&nbsp;05&nbsp;&nbsp;02&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Atık Su Gelirleri</div>
              </div>
            </div>
