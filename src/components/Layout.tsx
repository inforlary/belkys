  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: GitMerge, label: 'Performans Eşleştirme', path: 'budget-performance-mapping', adminOnly: true },
        ...
        { icon: Database, label: 'Geçmiş Veri Yönetimi', path: 'budget-performance-historical', adminOnly: true },
        { icon: DollarSign, label: 'Müdürlük Bütçe Verileri 2024', path: 'department-budget-data-2024', strictAdminOnly: true },
        { icon: LayoutDashboard, label: 'Performans Dashboard', path: 'budget-performance-program-dashboard', adminOnly: true },
