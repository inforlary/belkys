...
import { Building2, LayoutDashboard, Target, Flag, BarChart3, Briefcase, Menu, X, LogOut, User, Users, Building, Calendar, Lock, MessageSquare, CheckSquare, CheckCircle, FileText, Network, File as FileEdit, CreditCard, Archive, ChevronDown, ChevronRight, DollarSign, Coins, TrendingUp, TrendingDown, Layers, FileBarChart, Settings, Wind, Grid2x2 as Grid, Shield, ShieldAlert, ShieldCheck, Activity, AlertTriangle, AlertCircle, ClipboardCheck, FileWarning, Search, Bell, FolderOpen, GitMerge, Database, Hash, Eye, GitBranch, Clock, Workflow, Award, FileSearch, Scale, Lightbulb, BookOpen, Package, Mail, Key, Download, UserCog, ListChecks, Star } from 'lucide-react';
  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: FileText, label: 'Raporlar', path: 'risk-management/reports' },
      ],
    },
    {
          ...
          {!profile?.is_super_admin && profile?.role !== 'president' && (
            <div className="pt-2">
              {menuSections.map((section) => {
                ...
                const mainModules = ['Stratejik Plan', 'Faaliyet Raporu', 'Bütçe PP', 'Risk Yönetimi', 'İç Kontrol', 'İş Akışı Yönetimi', 'Proje Yönetimi'];
                ...
                const moduleColors: { [key: string]: string } = {
                  ...
                  'İç Kontrol': 'border-l-4 border-orange-400',
                  'İş Akışı Yönetimi': 'border-l-4 border-teal-400',
                  'Proje Yönetimi': 'border-l-4 border-cyan-400'
                };
