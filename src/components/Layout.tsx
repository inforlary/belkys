...
const [expandedSections, setExpandedSections] = useState<string[]>([]);
  ...
  const menuSections: MenuSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Calendar, label: 'Takvim ve Planlama', path: 'risk-calendar', adminOnly: true },
        { icon: Users, label: 'Toplantı Planları', path: 'meeting-plans', adminOnly: true },
        { icon: Bell, label: 'Hatırlatıcılar', path: 'reminders', adminOnly: true },
        { icon: Building2, label: 'Kurumsal Çerçeve', path: 'institutional-framework', adminOnly: true },
        { icon: GitBranch, label: 'Organizasyon Yönetimi', path: 'organization-management', adminOnly: true },
        { icon: Activity, label: 'Süreç Yönetimi', path: 'process-management', adminOnly: true },
        { icon: Users, label: 'Rol ve Yetki Yönetimi', path: 'ic-role-management', adminOnly: true },
        { icon: Lock, label: 'Hassas Görevler', path: 'sensitive-tasks', adminOnly: true },
        { icon: Scale, label: 'Etik Yönetimi', path: 'ethics-management', adminOnly: true },
        { icon: Target, label: 'Stratejik Entegrasyon', path: 'strategic-integration', adminOnly: true },
        { icon: Target, label: 'İç Kontrol Planları', path: 'internal-control-plans', adminOnly: true },
        { icon: FileText, label: 'KİKS Standartları', path: 'kiks-standards', adminOnly: true },
        { icon: CheckCircle, label: 'Standart Uyum Durumu', path: 'standards-compliance', adminOnly: true },
        ...
        { icon: Activity, label: 'Risk Tolerans Analizi', path: 'risk-tolerance-analysis', adminOnly: true },
        { icon: BarChart3, label: 'Risk Göstergeleri', path: 'risks/indicators' },
        { icon: TrendingUp, label: 'Sapma Analizi', path: 'variance-analysis', adminOnly: true },
        { icon: Users, label: 'Çalıştay Yönetimi', path: 'workshop-management', adminOnly: true },
        { icon: ShieldCheck, label: 'Kontrol Faaliyetleri', path: 'control-activities' },
        { icon: GitMerge, label: 'Kontrol-Risk İlişkilendirme', path: 'control-risk-mapping', adminOnly: true },
        { icon: CheckSquare, label: 'Kontrol Testi/Etkinlik', path: 'control-testing', adminOnly: true },
        { icon: FileText, label: 'Prosedür Yönetimi', path: 'procedure-management', adminOnly: true },
        { icon: Users, label: 'Görevler Ayrılığı', path: 'segregation-of-duties', adminOnly: true },
        { icon: FileSearch, label: 'İç Denetim', path: 'internal-audit-management' },
        { icon: Building2, label: 'Dış Denetim', path: 'external-audit-management' },
        { icon: Award, label: 'Kalite Denetimleri', path: 'quality-audits' },
        { icon: Scale, label: 'Yasal Uyumluluk', path: 'legal-compliance' },
        { icon: Eye, label: 'Sürekli İzleme', path: 'continuous-monitoring' },
        { icon: Search, label: 'Öz Değerlendirme', path: 'monitoring-evaluation' },
        ...
        { icon: CheckCircle, label: 'Aksiyon Takibi', path: 'action-tracking', adminOnly: true },
        { icon: Lightbulb, label: 'İyileştirme Önerileri', path: 'improvement-suggestions' },
        { icon: BookOpen, label: 'Öğrenilen Dersler', path: 'lessons-learned' },
        { icon: AlertCircle, label: 'İhbar ve Şikayet', path: 'whistleblower-system' },
        ...
        { icon: FileText, label: 'Doküman ve Şablonlar', path: 'document-templates' },
      ],
    },
    {
    ...
    },
    {
      ...
      icon: Award,
      items: [
        { icon: Award, label: 'Kalite Yönetimi', path: 'quality-management' },
        { icon: Search, label: 'Kalite Denetimleri', path: 'quality-audits' },
        { icon: Lightbulb, label: 'İyileştirme Önerileri', path: 'improvement-suggestions' },
      ],
    },
    {
  ...
  const bottomMenuItems: MenuItem[] = [
    ...
    { icon: Bell, label: 'Hatırlatmalar', path: 'reminders', adminOnly: true },
